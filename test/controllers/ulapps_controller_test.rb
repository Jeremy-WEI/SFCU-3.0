...
class UlappsControllerTest < ActionController::TestCase
  ...
  test "should generate csv file and zip file" do
    get :export, exports: [@ulapp.id]
    assert File.exists? ("public/uploads/ulapp/ulapps_file.csv")
    assert File.exists? ("public/uploads/ulapp/ulapp.zip")
  end
